...
import { bankAdminLoginAction } from "@/lib/actions/auth";
...
export default function BankAdminLoginPage({
  ...
  const boundAction = bankAdminLoginAction.bind(null, slug);
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-bold text-slate-900">Bank Admin</h1>
          <p className="mt-1 text-sm text-slate-500">
            <span className="font-medium capitalize">{slug.replace(/-/g, " ")}</span> bank paneli
          </p>
        </div>
